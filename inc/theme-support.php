 ...
 */
  ...
  function thirty_eight_register_nav_menu(){
...
add_action( 'after_setup_theme', 'thirty_eight_register_nav_menu' );
...
*/
  ...
  function thirty_eight_copyright() {
  ...
  function thirty_eight_sidebar_init(){

    register_sidebar( $args = array(
      'name' => esc_html__( 'Thirty Eight Sidebar', 'thirty-eight' ),
      'id' => 'thirty-eight-sidebar',
      'description' => 'Dynamic right sidebar',
      'before_widget' => '<section id="%1$s" class="thirty-eight-widget %2$s">',
      'after_widget' => '</section>',
      'before_title' => '<h2 class="thirty-eight-widget-title">',
      'after_title' => '</h2>'
    ) );

  }

  add_action( 'widgets_init', 'thirty_eight_sidebar_init' );
  ...
  function thirty_eight_posted_meta(){
  ...
  function thirty_eight_get_attachment( $num = 1 ){
  ...
  function thirty_eight_grab_url(){
  ...
  function thirty_eight_post_navigation(){
