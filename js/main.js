 ...
 */
 $(document).on('click', '.js-toggleSidebar', function() {
        $('.thirty-eight-sidebar').toggleClass('sidebar-closed');
  ...
  */
  ...
  $('.contactForm').on('submit', function(e) {
       ...
       var thirty_eight_nonce_field = form.find('#thirty_eight_nonce_field').val();
       ...
       $.ajax({
           ...
           type: 'post',
           data: {
               thirty_eight_nonce_field: thirty_eight_nonce_field,
               name: name,
               email: email,
               message: message,
               action: 'thirty_eight_save_user_contact_form'
